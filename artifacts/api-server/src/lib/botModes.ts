...
export const BulkOrderItemSchema = z.object({
  ...
  optimalThreshold: z.number().min(0).max(1).optional(),
  profitabilityVerified: z.boolean().optional(),
  kellyFraction: z.number().min(0).optional(),
  mlSizingMultiplier: z.number().min(0).optional(),
